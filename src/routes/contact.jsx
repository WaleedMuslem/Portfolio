...
import { FaGithub, FaInstagram, FaPaperPlane, FaLinkedin } from 'react-icons/fa'
...
function Contact() {
  ...
  const sendEmail = () => {
    ...
    emailjs.sendForm('service_ub4lllq', 'template_lmejwel', form.current, 'maKRoVWkAbP9W29_W')
      .then((result) => {
      ...
      <div className="Contact">
        ...
        <motion.div className="Contact-Header">
            <div className="Contact-Title">
              <TypeAnimation sequence={["",1500,"waleedmosllm2020@gmail.com />", ()=>{setContactReady(true)}]} cursor={false} speed={80} />
            </div>
        </motion.div>
